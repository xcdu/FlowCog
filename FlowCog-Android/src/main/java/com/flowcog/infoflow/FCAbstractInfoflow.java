...
import com.flowcog.infoflow.cfg.FCBiDiICFGFactory;
import java.io.File;
 ...
 *
 */
public abstract class FCAbstractInfoflow implements IInfoflow {
   ...
   */
  public FCAbstractInfoflow(BiDirICFGFactory icfgFactory, String androidPath, boolean forceAndroidJar) {
    if (icfgFactory == null) {
      FCBiDiICFGFactory factory = new FCBiDiICFGFactory();
