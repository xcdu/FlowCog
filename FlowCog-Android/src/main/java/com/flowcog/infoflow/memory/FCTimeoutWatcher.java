 ...
 *
 */
public class FCTimeoutWatcher implements IMemoryBoundedSolverStatusNotification {
  ...
  /**
   * Creates a new instance of the {@link FCTimeoutWatcher} class
   *
   * @param timeout
   *            The timeout in seconds after which the solvers shall be
   *            stopped
   */
  public FCTimeoutWatcher(long timeout) {
   ...
   */
  public FCTimeoutWatcher(long timeout, InfoflowResults res) {
    this.timeout = timeout;
    this.results = res;
  }
